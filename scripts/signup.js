import { signUpUser, initAuthObserver } from '../scripts/firebase-config.js';
...
class SignupPage {
    ...
    async handleSignup(e) {
        ...
        if (email === 'raiyansarwar022@gmail.com') {
            this.showFormError('This email is reserved for admin and cannot be used for user signup.');
            return;
        }
        ...
        try {
            ...
            if (result.success) {                this.showSuccessMessage('Account created successfully! Redirecting...');
